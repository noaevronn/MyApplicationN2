...
public class AppConstants
{
    ...
    public static final float[] arrY = {(float) ((Y - RADIUS) + (0.1*RADIUS)), (float) (Y-0.6*RADIUS), Y, (float) (Y+ 0.6*RADIUS), (float) ((Y + RADIUS) - (0.3*RADIUS)), (float) (Y+ 0.5*RADIUS), Y, (float) (Y - 0.7*RADIUS)};
